...
# load files
raw_file_path="/Users/zwy/research/MetroGAN/Data/population/landscan-global-2000-assets/landscan-global-2000.tif"

built_area=rasterio.open(raw_file_path)
print("read_file:",raw_file_path,'\n',"crs:",built_area.crs,"bounds:",built_area.bounds)

#city points
city_path="/Users/zwy/research/MetroGAN/Data/city_centroids.gpkg"
...
def clip_pic(cities,raster_data,w,out_filepath):
	...
	for index,city in cities.iterrows():
		...
		file_name="{id}-{country}-{province}-{city}".format(id=index,country=city["country"],province=city["province"],city=city["city"])
		print(index)
...
clip_pic(cities,built_area,100,"/Users/zwy/research/MetroGAN/Data/pop raw/pop raw 2000/")
