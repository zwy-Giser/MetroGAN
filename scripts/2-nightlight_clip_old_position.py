...
#读取文件
# built area
built_area=rasterio.open(r"D:\BaiduNetdiskDownload\F182013.v4c_web.avg_vis.tif")
print("read_file:GHS_BUILT_LDSMT_GLOBE_R2018A_3857_30_V2_0-ESRI.vrt","crs:",built_area.crs,"bounds:",built_area.bounds)

#读取城市点数据
cities=gpd.read_file(r"D:\BaiduNetdiskDownload\city_point_pop.shp",encoding="utf-8")
...
clip_pic(cities_over100K,built_area,100,"D:\\BaiduNetdiskDownload\\DMSP\\")
