...
#读取文件
# built area
built_area=rasterio.open(r"C:\research\city_architecture\data\original data\built area\GHS_30_wgs84.vrt")
...
clip_pic(cities,built_area,100,"C:\\research\\city_architecture\\data\\dataset20211214\\unresample\\built area\\")
