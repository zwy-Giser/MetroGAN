...
'''#读取文件
# built area
built_area=rasterio.open(r"C:\research\city architecture\data\GHS_resample_wgs84\GHS_wgs84.vrt")
print("read_file:GHS_BUILT_LDSMT_GLOBE_R2018A_3857_30_V2_0-ESRI.vrt","crs:",built_area.crs,"bounds:",built_area.bounds)


# landscan pop
pop_area=rasterio.open(r"C:\research\city architecture\data\LandScan Global 2019\LandScan_pop2019_web_mercator.tif")
print("read_file:LandScan_pop2019_web_mercator","crs:",pop_area.crs,"bounds:",pop_area.bounds)
'''
# water surface

water_area=rasterio.open(r"C:\research\city_architecture\data\original data\water_area\water.vrt")
print(water_area.shape)
#读取城市点数据
...
clip_pic(cities,water_area,100,"C:\\research\\city_architecture\\data\\dataset20211214\\unresample\\water\\")
